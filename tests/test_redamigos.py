...
class TestRedAmigos(BaseTestClass):
    ...
    def test_acceder_a_perfil_ajeno_responder_solicitud_denegar(self):
        ...
        # ESTAS PRUEBAS COINCIDEN TAMBIÉN PARA CUANDO SE INTENTA AGREGAR/ELIMINAR/RESPONDER 
        # SOLICITUD/CANCELAR SOLICITUD A ALGUIEN DESDE LA LISTA DE AMIGOS DE UN PERFIL 
        # PORQUE COINCIDEN LAS LLAMADAS A LOS MÉTODOS
